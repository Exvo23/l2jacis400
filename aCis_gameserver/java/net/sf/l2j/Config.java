...
public final class Config
{
	...
	public static final String L2JDev_FILE = "./config/custom/L2JDev.properties";
	...
	*/
	...
	public static void load()
	{
		if (Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			DUNGEON_COIN_ID = L2JDev.getProperty("DungeonCoinId", 15);
			CONT_DUNGEON_ITEM = L2JDev.getProperty("DungeonContItem", 15);

			
			DUNGEON_ITEM_RENEWAL0 = L2JDev.getProperty("DungeonRenewalHtml0", 15);
			DUNGEON_ITEM_RENEWAL1 = L2JDev.getProperty("DungeonRenewalHtml1", 15);
			DUNGEON_ITEM_RENEWAL2 = L2JDev.getProperty("DungeonRenewalHtml2", 15);
			DUNGEON_ITEM_RENEWAL3 = L2JDev.getProperty("DungeonRenewalHtml3", 15);
			DUNGEON_ITEM_RENEWAL4 = L2JDev.getProperty("DungeonRenewalHtml4", 15);
           ...
           // RESTART_PACKET_PUNISH = server.getProperty("RespawnPacketPunish", 2);
            ...
            CUSTOM_START_LVL = L2JDev.getProperty("CustomStartLvl", 1);
            CUSTOM_SUBCLASS_LVL = L2JDev.getProperty("CustomSubclassLvl", 40);
            
			CHAR_TITLE = L2JDev.getProperty("CharTitle", false);
	        ADD_CHAR_TITLE = L2JDev.getProperty("CharAddTitle", "Welcome");
	        
	        FORBIDDEN_NAMES = L2JDev.getProperty("ForbiddenNames", "").split(",");
	        GM_NAMES = L2JDev.getProperty("GmNames", "").split(",");
			...
			PARTY_ZONE_CHAMPIONS = L2JDev.getProperty("ListChampions", "2375,3500,3501,3502,4422,4423,4424,4425,6648,6649,6650");
			...
			String[] partyReward = L2JDev.getProperty("PartyZoneRewardList", "57,100000").split(";");
			...
			PARTY_FARMANNONCER = L2JDev.getProperty("TownAnnoncer", "Abandoned Camp");
			
			EVENT_BEST_FARM_TIME = Integer.parseInt(L2JDev.getProperty("EventBestFarmTime", "1"));
			monsterId = Integer.parseInt(L2JDev.getProperty("MonsterId", "1"));
			EVENT_BEST_FARM_INTERVAL_BY_TIME_OF_DAY = L2JDev.getProperty("BestFarmStartTime", "20:00").split(",");
			PARTY_FARM_BY_TIME_OF_DAY = Boolean.parseBoolean(L2JDev.getProperty("PartyFarmEventEnabled", "false"));
			NPC_SERVER_DELAY = L2JDev.getProperty("npcServerDelay", 70);
			
			PARTY_EVENT_START = L2JDev.getProperty("PartyFarmEventEnable", true);
			PARTY_DROP_EVENT_INTERVAL = L2JDev.getProperty("PartyDropStartTime", "20:00").split(",");
			PARTY_DROP_EVENT_TIME = L2JDev.getProperty("PartyDropEventTime", 1);
			
			PART_ZONE_MONSTERS = L2JDev.getProperty("ListChampions");
			PART_ZONE_MONSTERS_ID = new ArrayList<>();
			for(String id : PART_ZONE_MONSTERS.split(","))
				PART_ZONE_MONSTERS_ID.add(Integer.parseInt(id));
			
			PARTY_ZONE_REWARDS = parseReward(L2JDev, "PartyZoneReward");
			
			String[] monsterLocs2 = L2JDev.getProperty("PartyMonsterLoc", "").split(";");
			String[] locSplit3 = null;
			
			CHAMPION_ID = L2JDev.getProperty("PartyMonsterId", 1);
