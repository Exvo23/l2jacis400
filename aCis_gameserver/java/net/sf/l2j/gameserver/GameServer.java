...
public class GameServer
{
	...
	public GameServer() throws Exception
	{
		...
		if (Config.PARTY_FARM_BY_TIME_OF_DAY && !Config.PARTY_EVENT_START)
		{
			PartyFarmEvent.getInstance().StartCalculationOfNextEventTime();
			_log.info("[Party Farm Time]: Enabled");
		}
		else if (Config.PARTY_EVENT_START && !Config.PARTY_FARM_BY_TIME_OF_DAY)
		{
