...
public class RewardVote implements IVoicedCommandHandler
{
	...
	public List<Player> _safePeople = new ArrayList<>();
	...
	private static void insertInDataBase(long dateHeVotedOnWebsite, String IPClient, Player activeChar)
	{
	...
	private static boolean canTakeReward(long dateHeVotedOnWebsite, String IPClient, Player activeChar)
	{
	...
	{
		private final Player _safeplayer;

		public PopSafePlayer(Player safeplayer)
		{
